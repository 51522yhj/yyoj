...
public abstract class CCodeSandboxTemplate implements CodeSandbox {
    ...
    public ExecuteMessage compileFile(File userCodeFile) {
        String compileCmd = String.format("gcc %s -o %s", userCodeFile.getAbsolutePath(), userCodeFile.getParentFile().getAbsolutePath() + File.separator + "main");
        log.info("compileCmd c = {}", compileCmd);
        try {
