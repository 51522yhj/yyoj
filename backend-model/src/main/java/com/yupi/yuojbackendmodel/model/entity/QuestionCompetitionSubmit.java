...
/**
 * 竞赛题目提交
 * @TableName question_competition_submit
 */
@TableName(value ="question_competition_submit")
@Data
public class QuestionCompetitionSubmit implements Serializable {
    /**
     * id
     */
    ...
    public boolean equals(Object that) {
        ...
        QuestionCompetitionSubmit other = (QuestionCompetitionSubmit) that;
